...
import (
	...
	"github.com/katallaxie/workers/internal/jshttp"
	"github.com/katallaxie/workers/internal/jsutil"
	"github.com/katallaxie/workers/internal/runtime"
)
...
func handleRequest(reqObj js.Value) (js.Value, error) {
	...
	ctx := runtime.New(context.Background(), reqObj)
